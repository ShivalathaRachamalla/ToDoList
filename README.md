...
The Exact overview of how the **Todo list Application** has been designed and working is described in the user Manual.

## Class Diagram

[![Class diagram](./img/Class_Diagram.png)](./Class_Diagram.png)

Generated the class diagram using _*"Plantuml"*_
...
Tested the **Application** using JList framework.
